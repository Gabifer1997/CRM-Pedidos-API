...
namespace Services
{
    public class ProdutoServices
    {
        ...
        public async Task<int> AdicionaProdutos(IConfiguration configuration, ProdutoRequestModel produto) => await new ProdutoDAL().InsertProdutos(configuration, produto);
